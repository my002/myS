...
#include "data/custom.h"   // Large iris, no sclera -OR-
...
// #include "data/myEy.h"        // Cartoon deer eye (DISABLE TRACKING)

// ESP 32 DISPLAY HARDWARE SETTINGS (screen type & connections)
#define TFT_COUNT 2        // Number of screens (1 or 2)
#define TFT1_CS 16         // TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
